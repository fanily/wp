...
class Walker_Simple_Example2 extends Walker_Category {  
     ...
     function start_el(&$output, $item, $depth=0, $args=array(), $id = 0) { 
		...
		$termchildren = get_term_children( $item->term_id, $item->taxonomy );
			...
			{
        		$output .= "<li class=\"list-group-item".$image_style."\"><a href='".esc_url( get_term_link( $item ) )."'><div style='float:left;' class='fontweightclasscustom fontsizeclasscustom'>".$img."</div><div style='float:left;margin-top:5px;margin-left:5px'>".esc_attr( $item->name )."</div>&nbsp;<div style='margin-right:5px;float:right;margin-top:3px;' class='fontweightclasscustom fontsizeclasscustom'>".$count."</div></a>";
			}
        	}
		else
		{
			if ($img == ''){
        		$output .= "<li class=\"list-group-item".$image_style."\"><a href='".esc_url( get_term_link( $item ) )."'><div style='float:left;margin-top:5px;' class='fontweightclasscustom fontsizeclasscustom'>".$img."&nbsp;&nbsp;".esc_attr( $item->name )."</div>&nbsp;<div style='margin-right:12px;float:right;margin-top:3px;' class='fontweightclasscustom fontsizeclasscustom'>".$count."</div></a>";
			}
			else
			{
        		$output .= "<li class=\"list-group-item".$image_style."\"><a href='".esc_url( get_term_link( $item ) )."'><div style='float:left;' class='fontweightclasscustom fontsizeclasscustom'>".$img."&nbsp;&nbsp;".esc_attr( $item->name )."</div>&nbsp;<div style='margin-right:12px;float:right;margin-top:3px;' class='fontweightclasscustom fontsizeclasscustom'>".$count."</div></a>";
			}
		}
    }  
